...
public class WriteTransposedFileTest {

    private final String path;

    public WriteTransposedFileTest(String path) {
        this.path = path;
    }
    ...
    public static List<String> excel() {
        return Arrays.asList(
            "src/test/resources/writeTransposed.xlsx"
            , "src/test/resources/writeTransposed.xls", "src/test/resources/writeTransposed.csv"
        );
    }
